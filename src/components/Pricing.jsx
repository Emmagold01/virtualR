...
export default function Pricing() {
  return (
    <div className="mt-20">
      <h2 className="text-3xl md:text-5xl text-center my-8 tracing-wider">
        Pricing
      </h2>
      <div className="flex flex-wrap">
        {pricingOptions.map((option, index) => (
          <div key={index} className="w-full p-2 md:w-1/2 lg:w-1/3">
            <div className="p-10 border border-neutral-700 rounded-xl">
              ...
              <p className="mb-8">
                ...
                <span className="text-neutral-400 traccking-tight">/Month</span>
              </p>
              <ul>
